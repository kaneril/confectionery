...
<html>
	...
	<div class="session">
		<ul class="filters">
			<li><a href="manager.php">Заказы</a></li>
			<li><a href="products_m.php">Продукция</a></li>
			
		</ul>
		
		<div class="user">
			<h3>Менеджер обыкновенный $name</h3>
		</div>
		<form class="order_number" action="products_m.php" method="post">
			<h3>
	...
	<div class="orders">
		...
		<form class="filters" action="products_m.php" method="post">
...
($_POST['product_id'] != '')
   ...
   $product_info=find_product($conn, get_post($conn, 'product_id'));
	if (htmlspecialchars($product_info["id"])==-1){
		...
		<div class="order">
			<a  href="products_m.php"><img class="close-button" src="../images/icons/cross.png" onclick = "document.getElementById('order').style.display='none';document.getElementById('fade').style.display='none'"></a>
...
_END;		
		...
		echo<<<_END
    <div id="fade" class="black-overlay"></div>
        <form action="products_m.php" enctype="multipart/form-data" method="post" id="order_list" class="order">
    ...
    for ($j = 0; $j<$rows; ++$j){
        ...
        <div class="b1 f1" id="product">
            ...
            <div class="text">
                ...
                <form action="products_m.php" method="post">
...
if (isset($_POST['change_password'])){
    ...
    echo<<<_END
 <div id="fade" class="black-overlay"></div>
     <form action="products_m.php"  method="post" id="order_list" class="order">
         <img class="close-btn" src="../images/icons/cross.png" onclick = "document.getElementById('order_list').style.display='none';document.getElementById('fade').style.display='none'">
