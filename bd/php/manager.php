...
<html>
	...
	<div class="session">
		...
		<form class="order_number" action="manager.php" method="post">
			<h3>
	...
	<div class="orders">
		...
		<form class="filters" action="manager.php" method="post">
...
($_POST['order_number'] != '')
	...
	if (htmlspecialchars($order_info["id"])==-1){
		...
		<div class="order">
			<a  href="manager.php"><img class="close-button" src="../images/icons/cross.png" onclick = "document.getElementById('order').style.display='none';document.getElementById('fade').style.display='none'"></a>
...
_END;		
		...
		echo<<<_END
    <div id="fade" class="black-overlay"></div>
        <form action="manager.php" method="post" id="order_list" class="order">
...
(isset($_POST['manager']))
    ...
    for ($j = 0; $j<$rows; ++$j){
        ...
        <tr>
        <td>$number&nbsp</td>
        <td><form action="manager.php" method="post">
